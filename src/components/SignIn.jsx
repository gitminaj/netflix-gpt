    ...
    <div>
        ...
        <div className="absolute bg-black top-0 w-[100vw] h-[100%] opacity-70"></div>
         ...
         <Header className="absolute top-0" />
          ...
          <form onSubmit={(e) => e.preventDefault() } className="bg-black absolute top-[10vw] left-[34vw] text-white flex flex-col w-[30%] h-[60%] rounded justify-around align-center items-center bg-opacity-80">
